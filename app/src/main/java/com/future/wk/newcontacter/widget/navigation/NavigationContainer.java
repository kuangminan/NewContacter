...
public abstract class NavigationContainer extends LinearLayout {
    ...
    public <T extends NavigationContainer> T setLefttButton(int resource,String title,OnClickListener listener){
        btn_left.setButton(resource,title,listener);
        return (T)this;
    }
    ...
    public <T extends NavigationContainer> T setRightButton(int resource,String title,OnClickListener listener){
        btn_right.setButton(resource,title,listener);
        return (T)this;
    }
